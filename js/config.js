...
const RELATORIOS = {
  ...
  leads_vibra_rj: { grupo:"Comercial & Receita", label:"🛢️ Vibra RJ — Leads, atividades e conversão", descricao:"Leads e negócios da Vibra RJ, atividades registradas (ligações, reuniões, tarefas...) e taxa de conversão até oportunidade e ganho.", handler:"catalogo", periodo:"todas", entidade:"leads" },
  ...
  carteira_sdr: { grupo:"SDR & Leads", label:"🗂️ Carteira do SDR — tarefas e leads sem trabalho", descricao:"Tarefas atrasadas e de hoje, leads sem nenhum contato ainda, e ação de tratar (registrar contato ou trocar status) direto no Bitrix — de qualquer SDR.", handler:"catalogo", periodo:"mensal" },
