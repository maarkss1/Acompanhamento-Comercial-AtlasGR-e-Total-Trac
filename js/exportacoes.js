...
const AJUDAS_UI = {
  ...
  relatorios: { titulo:"Relatórios", html:`<p>Os relatórios combinam campos, filtros e regras de negócio já mapeadas no extrator.</p><ul><li><strong>Jornada:</strong> cliente único, histórico e movimentações.</li><li><strong>Forecast:</strong> fechado, pendentes, pipeline e previsão.</li><li><strong>Análise SDR:</strong> atividade diária, clientes diferentes, jornada e conversão de qualquer SDR.</li><li><strong>Qualidade:</strong> campos faltantes, aging, SLA e duplicidade.</li></ul>` },
